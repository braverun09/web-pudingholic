...
export default function ToppingsPage() {
    ...
    const [form, setForm] = useState<Partial<Topping>>({ name: "", description: "", emoji: "" });
                ...
                <form onSubmit={handleSave} className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input required type="text" value={form.emoji || ""} onChange={e => setForm({ ...form, emoji: e.target.value })} className="w-full px-4 py-2 border rounded-lg" />
                        </div>
                    ...
                    <div className="flex gap-2 pt-2">
                        ...
                        {isEditing && (
                            <button type="button" onClick={() => { setIsEditing(false); setForm({ name: "", description: "", emoji: "" }) }} className="bg-gray-200 text-gray-800 px-6 py-2 rounded-lg hover:bg-gray-300">
                                Cancel
                            </button>
                        )}
                    </div>
